...
<head>
  ...
  <title>Registered Billers</title>
</head>
<body>
...
<c:if test="${sessionScope.customer != null}">
  ...
  <div class="row container-fluid">
    ...
    <div class="col col-9">
      <div class="row m-2">
        <span class="text text-center fs-4 fw-bold">Registered Billers</span>
        <div class="col">
		...
		%>
          <div class="card-body row m-1 border-bottom border-dark">
            ...
            <div class="col col-3 ">
              <a href="/customer/view-biller-products?billerId=<%=biller.getBillerId()%>" class="btn btn-success mt-4 w-100">View Products</a>            
            </div>
          </div>
	<% } %>
        </div>
