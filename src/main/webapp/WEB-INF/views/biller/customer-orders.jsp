...
<c:if test="${sessionScope.biller != null}">
  ...
  <div class="row container-fluid">
    ...
    <div class="col col-9">
      <div class="row m-2">
        <span class="text text-center fs-4 fw-bold">Customer Orders</span>
		...
		%>
          ...
          <div class="card-body row m-2 border-bottom border-dark">
            <div class="col col-2">
              <img src="https://i.postimg.cc/mZP117f1/orders.png" width="80" height="80" alt="Biller Logo">
            </div>
            <div class="col col-6">
            ...
            <div class="col col-2 mt-4">
             	<a href="/biller/view-order?orderId=<%= order.getOrderid()%>" class="btn btn-primary">View Details</a>             
            </div>
          </div>
