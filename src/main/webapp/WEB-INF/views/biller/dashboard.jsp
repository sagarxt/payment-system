...
<c:if test="${sessionScope.biller != null}">       
  ...
  <div class="row container-fluid">
    ...
    <div class="col col-9">
      <div class="row m-2">
        <span class="text text-center fs-4 fw-bold"></span>
        ...
        <div class="col">
			<div class="row m-3">
			  ...
			  <div class="col-sm-6">
			    <div class="card text-center border-0">
			    	<div  class="text-center m-2">
				   	 	<img src="https://i.postimg.cc/mZP117f1/orders.png" class="" alt="..." width="100px" height="100px">
				   	 </div>
			      <div class="card-body">
			      	<h3>All Orders : ${bdd.totalOrders }</h3>
			        <a href="/biller/all-orders" class="btn btn-primary m-2">View Details</a>
			      </div>
			    </div>
			  </div>
			  ...
			  <div class="col-sm-6">
			    <div class="card text-center border-0">
			    	<div  class="text-center m-2">
				   	 	<img src="https://i.postimg.cc/MTKKwJxj/pending.png" class="" alt="..." width="100px" height="100px">
				   	 </div>
			      <div class="card-body">
			      	<h3>Pending Orders : ${bdd.pendingOrders }</h3>
			        <a href="/biller/pending-orders" class="btn btn-primary m-2">View Details</a>
			      </div>
			    </div>
			  </div>
			...
			<div class="row m-3 mt-4">
			  ...
			  <div class="col-sm-6">
			    <div class="card text-center border-0">
			    	<div  class="text-center m-2">
				   	 	<img src="https://i.postimg.cc/1RbnG4sC/products.png" class="" alt="..." width="100px" height="100px">
				   	 </div>
			      <div class="card-body">
			      	<h3>Total Products : ${bdd.totalProducts }</h3>
			        <a href="/biller/view-products" class="btn btn-primary m-2">View Details</a>
			      </div>
			    </div>
			  </div>
			  ...
			  <div class="col-sm-6">
			    <div class="card text-center border-0">
			      ...
			      <div class="card-body">
			      	<h3>Registered Users : 3</h3>
			        <a href="/biller/registered-customers" class="btn btn-primary m-2">View Details</a>
			      </div>
			    </div>
			  </div>
          ...
          <!--   <span class="btn btn-primary w-100"></span> -->
        </div>
      </div>
    </div>
  </div>
