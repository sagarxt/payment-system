...
<c:if test="${sessionScope.biller != null}">       
  ...
  <div class="row container-fluid">
    ...
    <div class="col col-9">
      <div class="row m-2">
        <span class="text text-center fs-4 fw-bold">Update Product</span>

        <div class="col">
	
		<div class="row m-2 container">
          <div class="d-flex justify-content-center mt-3">
            <form class="form" action="/biller/edit-product" method="post">
              <div class="mb-3">
              ...
              <div class="mb-2">
		        ...
		        <textarea class="form-control" id="description" rows="2" name="description" required>${product.description }</textarea>
		        <div id="emailHelp" class="form-text text-white">Mention Product Details Briefly with Expire Date.</div>
		      </div>
		      <select class="form-select" aria-label="Default select example" name="category">
		        <option value="${product.category }" selected>Chose a Category</option>
