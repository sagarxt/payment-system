...
<c:if test="${sessionScope.biller != null}">       
  ...
  <div class="row container-fluid">
    ...
    <div class="col col-9">
      <div class="row m-2">
        <span class="text text-center fs-4 fw-bold">Pending Orders</span>
		...
		%>
          ...
          <div class="card-body row m-2 border-bottom border-dark">
            <div class="col col-2">
              <img src="https://i.postimg.cc/MTKKwJxj/pending.png" width="80" height="80" alt="Biller Logo">
            </div>
            <div class="col">
              ...
              <span class="text fw-bold row">Customer : <%= order.getCustomer().getName() %></span>
              <span class="text row" id="convertedDateTime"></span>
            </div>
            <div class="col mt-4">
              <span class="text fw-bold row btn">Rs. <%= order.getProduct().getPrice() %></span>
              <a href="/biller/accept-order?orderId=<%= order.getOrderid()%>" class="btn btn-primary ms-3">Accept</a>
              <a href="/biller/reject-order?orderId=<%= order.getOrderid()%>" class="btn btn-danger ms-1">Reject</a>
            </div>
          </div>
